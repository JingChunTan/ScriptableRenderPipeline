...
#pragma warning restore 618
        ...
        void UpdateAreaLightBoundingBox()
        {
        ...
        void UpdateBoxLightBoundingBox()
        {
        ...
        void UpdatePyramidLightBoundingBox()
        {
            m_Light.useShadowMatrixOverride = true;
            m_Light.useBoundingSphereOverride = true;
            ...
            if (lightTypeExtent == LightTypeExtent.Punctual && m_Light.type == LightType.Spot)
            {
                switch (spotLightShape)
                {
                    case SpotLightShape.Box:
                        UpdateBoxLightBoundingBox();
                        break;
                    case SpotLightShape.Pyramid:
                        UpdatePyramidLightBoundingBox();
                        break;
                    default: // Cone
