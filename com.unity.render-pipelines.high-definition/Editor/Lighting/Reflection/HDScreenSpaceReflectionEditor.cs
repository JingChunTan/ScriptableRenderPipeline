    ...
    public class HDScreenSpaceReflectionEditor : VolumeComponentEditor
    {
        ...
        public override void OnInspectorGUI()
        {
                ...
                ?.currentPlatformRenderPipelineSettings.supportSSR ?? false)
            {
                ...
                EditorGUILayout.HelpBox("Screen Space Reflection is not supported by the current HDRenderPipelineAsset or there is no one in use.", MessageType.Error, wide: true);
            }
        }
    }
}
